...
* in gmail manually all processed emails (current Claude MCP integration with Gmail cannot do that)
* save generated Post text

## Generate image

* run ChatGPT, project "Claude on DevOps"
* start new chat by typing: "Generate a new image based on Claude's post: (copy-paste Post text here)"
