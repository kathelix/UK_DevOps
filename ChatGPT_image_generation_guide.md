...
- is readable in feed previews of the social plaforms
...
Do **not** make the series visually sterile or corporate. It should feel hand-crafted, humorous, and memorable.
...
### 4. Bottom captions
Use bottom captions sparingly.
Earlier tests showed bottom-heavy layouts are weaker in social media preview.
...
1. **Landscape 1200 x 627 style composition**
...
> Generate a new satirical image from scratch in the established vintage editorial-cartoon series style. Use a wide 1200 x 627 landscape composition optimized for social media (LinkedIn, Instagram) feed preview and mobile readability. Keep all important text inside safe margins, minimize in-scene text, double-check spelling, reduce clutter, and focus on one strong visual metaphor plus at most 2-3 main jokes. Preserve series identity, but do not reuse the same layout, character pose, or composition from earlier images.
